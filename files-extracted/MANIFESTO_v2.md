# Local Agent — Manifesto v2 (10× ambition)
...
## 7. Business model — bolder

V1 said $5M Y1 → $50M Y2 → $250M+ Y3. Time to scale ambitions.

### Solo Sovereign — $49/month or $490/year
- Full agent, all features, single machine
- Free knowledge base updates (signed artifacts)
- Community support
- Target: 1M users by 2030, $500M ARR contribution

### Team Sovereign — $99/user/month, minimum 5 seats
- Everything in Solo
- LAN-based team memory sync, RBAC, shared KB
- Compliance reports for SOC2 / HIPAA / FedRAMP / IRAP / ISO 27001
- 24/5 support
- Target: 100k teams by 2030, $1.2B ARR

### Enterprise Sovereign — Custom pricing (typically $500k–$5M/year per org)
- Air-gapped on-prem deployment
- Federated multi-site intelligence
- Customer-specific fine-tuning pipeline
- Onsite engineers for first 6 months
- Compliance attestation for defense, healthcare, finance, infrastructure
- Target: 500 enterprise contracts by 2030, $1.5B ARR

### Sovereign Compute Platform — license to third parties (V4+)
- Other software companies build on our offline runtime
- Revenue share or per-seat licensing
- Target: 50+ partner products by 2030, $300M ARR
